...
var timepickerDirectiveHeader = $.extend({},timepickerDirective);
timepickerDirectiveHeader.templateUrl =  '/partials/directives/timepicker-dropdown-header-directive.html';
...
zedAlphaDirectives
    .directive('hlTimepicker', ['$timeout','DateHelpers','FullDateFormat','$rootScope','$parse','DateHolder', function ($timeout,DateHelpers,FullDateFormat,$rootScope,$parse,DateHolder) {
        ...
        return timepickerDirectiveHeader;
    }]);